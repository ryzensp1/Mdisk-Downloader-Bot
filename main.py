...
# app
bot_token = os.environ.get("TOKEN", "5522576507:AAGucQOsPmDzYzWqK27Ty2YkvCfqraBRtLU") 
api_hash = os.environ.get("HASH", "40f25e810b628be54bcb44a58eb8d69e") 
api_id = os.environ.get("ID", "7460290")
